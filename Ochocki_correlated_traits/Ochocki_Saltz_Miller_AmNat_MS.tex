...
% Discussion -------------
\section*{Discussion}
Long-standing ecological theory and more recent eco-evolutionary work emphasize the key roles of demography and dispersal traits as drivers of invasion dynamics and the evolutionary forces that act on them -- but in both classes of theory, regeneration and movement are typically assumed to operate independently. 
On the other hand, a large body of literature emphasizes connections between demography and dispersal traits through a myriad of mechanisms and in varying directions, ranging form trade-offs due to physiological costs of dispersal to dispersal `syndromes' that package several life history traits into a multivariate phenotype. 
Our work provides conceptual unification between these perspectives by examining how trait correlations that vary in type, direction, and magnitude can affect the ecological and evolutionary dynamics of range expansion. 
Our results carry value and significance at two levels. 
