...
\subsubsection*{Speed and variability of invasions}

\begin{figure}[h!]
\centering
\includegraphics[width=0.5\linewidth]{Figures/sim_invasions_default_h2}
\label{corr:sim_default}
\end{figure}

\begin{figure}[h!]
\centering
\includegraphics[width=0.9\linewidth]{Figures/sim_invasions_vary_h2}
\label{corr:sim_vary_h2}
\end{figure}

\subsubsection*{Trait evolution}
