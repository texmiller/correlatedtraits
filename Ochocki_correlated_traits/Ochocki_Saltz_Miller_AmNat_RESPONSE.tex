...
We could not find a relevant 2016 Phillips paper but perhaps the reviewer intended Hudson et al. 2016, which documents dispersal-reproduction trade-offs in cane toads; we have added this citation to the paper (l. \ref{}).
...
\\
\\
We also emphasize that the focus on ``trade-offs'' is too limiting, in our opinion.
Positive trait correlations are widely reported, and we show that evolutionary effects on expansion speed and variability can be very different for positive versus negative correlations.
\\
\\
The idea of trade-offs limiting the evolution of ``super-organisms'' is very interesting and we have added this idea to the Discussion section (l. \ref{}).}
...
\response{The reviewer's interpretation is correct. We have revised this section for clarity (l. \ref{}).}
...
\response{We have updated our notation in Eqn 4 (l. \ref{}).}
...
\response{We now followed this suggestion (l. \ref{}).}

\comment{rstan in text citation seems to have formatted incorrectly.}
\response{Thanks for catching this. It is now corrected (l. \ref{}).}
...
\response{We have moved a few details into the main text, with the goal of making our results a little easier to follow (l. \ref{}).
For space, most of the simulation methods remain in the Appendix.}
...
\response{This is an interesting idea that we have incorporated into our revision (l. \ref{}).}
