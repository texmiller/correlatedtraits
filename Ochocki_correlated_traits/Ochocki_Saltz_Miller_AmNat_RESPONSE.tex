...
\response{As long as the reviewer thinks the current layout is sufficient then we have made no changes, the manuscript is already quite a bit longer due to additions in the Discussion}
