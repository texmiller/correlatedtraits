...
%Regarding the AE's concerns about variance being greater within versus among groups of full sibs, this precisely what our breeding design was meant to disentangle.
%While it is fair to question the biological relevance of our dispersal set-up in this lab system, the results of this study and our previous work (Ochocki and Miller 2017) clearly indicate that, in this context, there is among-brood variance in dispersal. \\
%\\
...
\response{We now include maternal effects in our analsis and simulation model. See response to AE Duckworth.}
